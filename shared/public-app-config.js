(function (root) {
  ...
  function validate(value){
    exact(value,['schemaVersion','network','board'],['privateFee']);check(value.schemaVersion===1,'Unsupported configuration version');
