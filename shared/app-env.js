...
function publicOperationFailure(error) {
  const messages={
    ...
    BB_DEPOSIT_MESSAGE_UNAVAILABLE:'Your ETH deposit is confirmed, but message availability could not be checked. Restore the connection and retry the original claim; do not deposit again.',
