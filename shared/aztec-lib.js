...
// 1. Simulates once to estimate gas
// 2. Pads gas by 10%
// 3. Calls optional preProveHook (can abort before wasting time on proving)
// 4. Proves the tx (slow, no retry)
// 5. Submits once and reconciles the exact transaction
// 6. Checks the canonical receipt
//
// rawNode is the node client used for submission and receipt reconciliation.
...
function createAztecWallet(pxe, aztecNode, rawNode, statusId, opts = {}) {
  ...
  class AztecWallet extends a.BaseWallet {
    ...
    async sendTx(executionPayload, opts) {
      ...
      // Separate proving from submission and canonical receipt reconciliation.
