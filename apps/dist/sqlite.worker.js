...
async function sqlite3InitModule(moduleArg = {}) {
  ...
  (function(Module2) {
    ...
    Module2["instantiateWasm"] = function callee(imports, onSuccess) {
  ...
  function assignWasmExports(wasmExports2) {
    ...
    _sqlite3mc_vfs_create = Module["_sqlite3mc_vfs_create"] = wasmExports2["sqlite3mc_vfs_create"];
    ...
    _sqlite3_bind_zeroblob = Module["_sqlite3_bind_zeroblob"] = wasmExports2["sqlite3_bind_zeroblob"];
    ...
    _sqlite3_next_stmt = Module["_sqlite3_next_stmt"] = wasmExports2["sqlite3_next_stmt"];
    ...
    _sqlite3mc_vfs_shutdown = Module["_sqlite3mc_vfs_shutdown"] = wasmExports2["sqlite3mc_vfs_shutdown"];
    ...
    _sqlite3mc_version = Module["_sqlite3mc_version"] = wasmExports2["sqlite3mc_version"];
    _sqlite3mc_config = Module["_sqlite3mc_config"] = wasmExports2["sqlite3mc_config"];
    _sqlite3mc_cipher_count = Module["_sqlite3mc_cipher_count"] = wasmExports2["sqlite3mc_cipher_count"];
    _sqlite3mc_cipher_index = Module["_sqlite3mc_cipher_index"] = wasmExports2["sqlite3mc_cipher_index"];
    _sqlite3mc_cipher_name = Module["_sqlite3mc_cipher_name"] = wasmExports2["sqlite3mc_cipher_name"];
    _sqlite3mc_cipher_name_copy = Module["_sqlite3mc_cipher_name_copy"] = wasmExports2["sqlite3mc_cipher_name_copy"];
    _sqlite3mc_config_cipher = Module["_sqlite3mc_config_cipher"] = wasmExports2["sqlite3mc_config_cipher"];
    _sqlite3mc_codec_data = Module["_sqlite3mc_codec_data"] = wasmExports2["sqlite3mc_codec_data"];
    _sqlite3_activate_see = Module["_sqlite3_activate_see"] = wasmExports2["sqlite3_activate_see"];
    _sqlite3_key = Module["_sqlite3_key"] = wasmExports2["sqlite3_key"];
    _sqlite3_key_v2 = Module["_sqlite3_key_v2"] = wasmExports2["sqlite3_key_v2"];
    _sqlite3_rekey_v2 = Module["_sqlite3_rekey_v2"] = wasmExports2["sqlite3_rekey_v2"];
    _sqlite3_rekey = Module["_sqlite3_rekey"] = wasmExports2["sqlite3_rekey"];
    _sqlite3mc_vfs_destroy = Module["_sqlite3mc_vfs_destroy"] = wasmExports2["sqlite3mc_vfs_destroy"];
    ...
    _sqlite3__wasm_kvvfsMakeKey = Module["_sqlite3__wasm_kvvfsMakeKey"] = wasmExports2["sqlite3__wasm_kvvfsMakeKey"];
    ...
    _sqlite3__wasm_kvvfs_decode = Module["_sqlite3__wasm_kvvfs_decode"] = wasmExports2["sqlite3__wasm_kvvfs_decode"];
    _sqlite3__wasm_kvvfs_encode = Module["_sqlite3__wasm_kvvfs_encode"] = wasmExports2["sqlite3__wasm_kvvfs_encode"];
  ...
  Module.runSQLite3PostLoadInit = async function(sqlite3InitScriptInfo, EmscriptenModule, sqlite3IsUnderTest) {
    ...
    globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
      ...
      capi.sqlite3_value_to_js = function(pVal, throwIfCannotConvert = true) {
        ...
        switch (valType) {
          ...
          case capi.SQLITE_BLOB: {
            ...
            if (n && !pBlob) sqlite32.WasmAllocError.toss(
      ...
      if (true) {
        ...
        capi.sqlite3changeset_new_js = (pChangesetIter, iCol) => __newOldValue(
          pChangesetIter,
          iCol,
          "sqlite3changeset_new"
        );
        capi.sqlite3changeset_old_js = (pChangesetIter, iCol) => __newOldValue(
          pChangesetIter,
          iCol,
      ...
      capi.sqlite3_js_retry_busy = function(maxTimes, callback, beforeRetry) {
        for (let n = 1; n <= maxTimes; ++n) {
          try {
            ...
            if (n < maxTimes && e instanceof SQLite3Error && e.resultCode === capi.SQLITE_BUSY) {
              continue;
            }
            throw e;
          }
      ...
      if ("undefined" !== typeof sqlite3IsUnderTest) {
        sqlite32.__isUnderTest = !!sqlite3IsUnderTest;
      }
      try {
      ...
      if (sqlite32.__isUnderTest) {
        ...
        const iw = sqlite32.scriptInfo?.instantiateWasm;
        if (iw) {
    ...
    globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
      ...
      const typedArrayToString = (typedArray, begin, end) => cache.utf8Decoder.decode(
      ...
      target.allocCString = (jstr, returnWithLength = false) => __allocCStr(
        jstr,
        returnWithLength,
        target.alloc,
        "allocCString()"
    ...
    globalThis.WhWasmUtilInstaller.yawl = function yawl(config) {
      ...
      const loadWasm = WebAssembly.instantiateStreaming ? () => WebAssembly.instantiateStreaming(wfetch(), config.imports || {}).then(finalThen) : () => wfetch().then((response) => response.arrayBuffer()).then((bytes) => WebAssembly.instantiate(bytes, config.imports || {})).then(finalThen);
      return loadWasm;
    }.bind(
    ...
    globalThis.Jaccwabyt = function StructBinderFactory(config) {
      ...
      const heap = config.heap, alloc = config.alloc, dealloc = config.dealloc, realloc = config.realloc || function() {
        toss("This StructBinderFactory was configured without realloc()");
      }, log = config.log || console.debug.bind(console), memberPrefix = config.memberPrefix || "", memberSuffix = config.memberSuffix || "", BigInt2 = globalThis["BigInt"], BigInt64Array2 = globalThis["BigInt64Array"], bigIntEnabled = config.bigIntEnabled ?? !!BigInt64Array2;
      let ptr;
      ...
      const __adaptorsFor = function(who) {
        let x = this.get(who);
        if (!x) {
          x = [/* @__PURE__ */ Object.create(null), /* @__PURE__ */ Object.create(null), /* @__PURE__ */ Object.create(null)];
          this.set(who, x);
        }
        return x;
      ...
      const __lookupMember = function(structInfo, memberName, tossIfNotFound = true) {
        ...
        if (!m && (memberPrefix || memberSuffix)) {
          ...
          if (!m && tossIfNotFound) {
            toss(
              sPropName(structInfo.name || structInfo.structName, memberName),
      ...
      const makeMemberWrapper = function f(ctor, name, si) {
        ...
        if (si.readOnly) {
          ...
          prop.set = function(v2) {
            ...
            else if (isPtrSig(si.signature) && !__isPtr(v2)) {
              if (isAutoPtrSig(si.signature) && v2 instanceof StructType) {
            ...
            new DataView(
              ...
              si.sizeof
            )[f.cache.setters[sigGlyph]](0, f.cache.sw[sigGlyph](v2), isLittleEndian);
          };
        }
        Object.defineProperty(ctor.prototype, key, prop);
      };
      const StructBinderImpl = function StructBinderImpl2(structName, si, opt = /* @__PURE__ */ Object.create(null)) {
        ...
        Object.keys(si.members || {}).forEach((k2) => {
          ...
          if (!m.members && !m.sizeof) {
            ...
            if (!m.sizeof) {
              toss(sPropName(structName, k2), "is missing a sizeof property.", m);
            }
          }
          if (void 0 === m.offset) {
        ...
        if (si.sizeof === 1) {
          si.signature === "c" || si.signature === "C" || toss(
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
      ...
      if (!!wasm.exports.sqlite3_progress_handler) {
        bindingSignatures.core.push(
          ["sqlite3_progress_handler", void 0, [
            "sqlite3*",
            "int",
            new wasm.xWrap.FuncPtrAdapter({
      ...
      if (!!wasm.exports.sqlite3_key_v2) {
        bindingSignatures.core.push(
          ...
          ["sqlite3mc_vfs_destroy", void 0, "string"],
          ["sqlite3mc_vfs_shutdown", void 0]
        );
      }
        ...
        bindingSignatures.int64.push(
          ...
          ["sqlite3_preupdate_hook", "*", [
            ...
            new wasm.xWrap.FuncPtrAdapter({
              ...
              contextKey: (argv) => argv[0],
              callProxy: (callback) => {
                return (p, db2, op, zDb, zTbl, iKey1, iKey2) => {
                  callback(
                    p,
                    db2,
                    op,
      ...
      if (wasm.bigIntEnabled && !!wasm.exports.sqlite3changegroup_add && !!wasm.exports.sqlite3session_create && !!wasm.exports.sqlite3_preupdate_hook) {
        ...
        bindingSignatures.int64.push(
          ...
          ["sqlite3session_table_filter", void 0, [
            "sqlite3_session*",
            new wasm.xWrap.FuncPtrAdapter({
              name: "xFilter",
              ...__ipsProxy,
      ...
      delete globalThis.Jaccwabyt;
      {
        ...
        if (wasm.exports.sqlite3_declare_vtab) {
          wasm.xWrap.argAdapter("sqlite3_index_info*", (v2) => __xArgPtr(v2 instanceof (capi.sqlite3_index_info || nilType) ? v2.pointer : v2))(
            "sqlite3_module*",
            (v2) => __xArgPtr(v2 instanceof (capi.sqlite3_module || nilType) ? v2.pointer : v2)
          );
        }
      ...
      const __dbCleanupMap = function(pDb2, mode) {
        ...
        return m;
      }.bind(Object.assign(/* @__PURE__ */ Object.create(null), {
      ...
      __dbCleanupMap.cleanup = function(pDb2) {
        ...
        for (const obj of [
          ...
          try {
            ...
            sqlite32.config.warn("close-time call of", name + "(", closeArgs, ") threw:", e);
          }
        }
      ...
      }
      {
        ...
        const __sqlite3CreateWindowFunction = wasm.exports.sqlite3_create_window_function ? wasm.xWrap(
        ...
        capi.sqlite3_create_function_v2 = function f(pDb2, funcName, nArg, eTextRep, pApp, xFunc, xStep, xFinal, xDestroy) {
          if (f.length !== arguments.length) {
            return __dbArgcMismatch(pDb2, "sqlite3_create_function_v2", f.length);
          } else if (0 === (eTextRep & 15)) {
            eTextRep |= capi.SQLITE_UTF8;
          } else if (capi.SQLITE_UTF8 !== (eTextRep & 15)) {
            return __errEncoding(pDb2);
        ...
        if (__sqlite3CreateWindowFunction) {
          capi.sqlite3_create_window_function = function f(pDb2, funcName, nArg, eTextRep, pApp, xStep, xFinal, xValue, xInverse, xDestroy) {
            if (f.length !== arguments.length) {
              return __dbArgcMismatch(pDb2, "sqlite3_create_window_function", f.length);
            } else if (0 === (eTextRep & 15)) {
              eTextRep |= capi.SQLITE_UTF8;
            } else if (capi.SQLITE_UTF8 !== (eTextRep & 15)) {
              return __errEncoding(pDb2);
      ...
      if (!capi.sqlite3_column_text) {
        const argStmt = wasm.xWrap.argAdapter("sqlite3_stmt*"), argInt = wasm.xWrap.argAdapter("int"), argValue = wasm.xWrap.argAdapter("sqlite3_value*"), newStr = (cstr, n) => wasm.typedArrayToString(
          wasm.heap8u(),
          Number(cstr),
          Number(cstr) + n
        );
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
      ...
      const debug = sqlite32.__isUnderTest ? outWrapper(console.debug.bind(console)) : outWrapper(sqlite32.config.debug);
      const warn = sqlite32.__isUnderTest ? outWrapper(console.warn.bind(console)) : outWrapper(sqlite32.config.warn);
      const error = sqlite32.__isUnderTest ? outWrapper(console.error.bind(console)) : outWrapper(sqlite32.config.error);
      ...
      const byteArrayToHex = function(ba) {
        ...
        for (const d of ba) {
          li.push(digits[(d & 240) >> 4], digits[d & 15]);
        }
        return li.join("");
      };
      const dbCtorApplySEEKey = function(db2, opt) {
        ...
        let stmt;
        try {
          stmt = db2.prepare("PRAGMA " + keytype + "=" + util.sqlite3__wasm_qfmt_token(key, 1));
          stmt.step();
          return true;
        } finally {
      ...
      dbCtorHelper.setVfsPostOpenCallback = function(pVfs, callback) {
        if (!(callback instanceof Function)) {
          toss3("dbCtorHelper.setVfsPostOpenCallback() should not be used with a non-function argument.", arguments);
        }
      ...
      Stmt.prototype = {
        ...
        bind: function() {
          ...
          if ("object" === typeof arg && !util.isBindableTypedArray(arg)) {
            ...
            Object.keys(arg).forEach((k2) => bindOne(
              this,
              k2,
              affirmSupportedBindType(arg[k2]),
              arg[k2]
            ));
            return this;
          } else {
      ...
      sqlite32.initWorker1API = function() {
        ...
        const wMsgHandler = {
          open: function(ev) {
            ...
            rc.persistent = !!sqlite33.capi.sqlite3_js_db_uses_vfs(db2.pointer, "opfs");
            rc.dbId = getDbId(db2);
          ...
          exec: function(ev) {
            ...
            try {
              ...
              const lastInsertRowId = !!rc.lastInsertRowId ? sqlite33.capi.sqlite3_last_insert_rowid(db2) : void 0;
          ...
          export: function(ev) {
            const db2 = getMsgDb(ev);
            const response = {
              byteArray: sqlite33.capi.sqlite3_js_db_export(db2.pointer),
        ...
        try {
          ...
          if (opt.catchExceptions) {
            ...
            for (const k2 of mnames) {
              ...
              else if ("xConnect" === k2 && methods.xCreate === m) {
                remethods[k2] = methods.xCreate;
              } else if ("xCreate" === k2 && methods.xConnect === m) {
                remethods[k2] = methods.xConnect;
              } else {
                remethods[k2] = fwrap(k2, m);
              }
            }
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
      if (sqlite32.config.disable?.vfs?.kvvfs) {
        return;
      }
      "use strict";
      const capi = sqlite32.capi, sqlite3_kvvfs_methods = capi.sqlite3_kvvfs_methods, KVVfsFile = capi.KVVfsFile, pKvvfs = sqlite32.capi.sqlite3_vfs_find("kvvfs");
      ...
      const util = sqlite32.util, wasm = sqlite32.wasm, toss3 = util.toss3, hop = (o, k2) => Object.prototype.hasOwnProperty.call(o, k2);
      ...
      const debug = sqlite32.__isUnderTest ? (...args) => sqlite32.config.debug?.("kvvfs:", ...args) : noop;
      const warn = (...args) => sqlite32.config.warn?.("kvvfs:", ...args);
      const error = (...args) => sqlite32.config.error?.("kvvfs:", ...args);
      class KVVfsStorage {
      ...
      const validateStorageName = function(n, mayBeJournal = false) {
        ...
        } else if (["-wal", "-shm"].filter((v2) => n.endsWith(v2)).length) {
          toss3(
            capi.SQLITE_MISUSE,
      ...
      const kvvfs = sqlite32.kvvfs = /* @__PURE__ */ Object.create(null);
      if (sqlite32.__isUnderTest) {
        kvvfs.log = Object.assign(/* @__PURE__ */ Object.create(null), {
          xOpen: false,
          xClose: false,
          xWrite: false,
          xRead: false,
      ...
      cache.storagePool = Object.assign(/* @__PURE__ */ Object.create(null), {
          ...
          for (const ear of store.listeners) {
            ...
            if (f) {
              ...
              if ("write" === eventName && ear.decodePages && +args[0] > 0) {
                ...
                ev.data = args.length ? args.length === 1 ? args[0] : args : void 0;
              }
              try {
      ...
      const originalIoMethods = (kvvfsFile) => originalMethods[kvvfsFile.$isJournal ? "ioJrnl" : "ioDb"];
        ...
        recordHandler: {
          xRcrdRead: (zClass, zKey, zBuf, nBuf) => {
            try {
              ...
              let i;
              for (i = 0; i < nV; ++i) {
                heap[wasm.ptr.add(zV, i)] = jV.codePointAt(i) & 255;
              }
              heap.copyWithin(
                Number(zBuf),
                Number(zV),
        ...
        vfs: {
          xOpen: function(pProtoVfs, zName, pProtoFile, flags, pOutFlags) {
            ...
            try {
              ...
              if (flags & (capi.SQLITE_OPEN_MAIN_DB | capi.SQLITE_OPEN_TEMP_DB | capi.SQLITE_OPEN_TRANSIENT_DB) && cache.rxJournalSuffix.test(jzClass)) {
                toss3(
                  capi.SQLITE_ERROR,
              ...
              if (opId === capi.SQLITE_FCNTL_PRAGMA && kvvfsInternal.disablePageSizeChange) {
                ...
                if ("page_size" === wasm.cstrToJs(zName)) {
                  ...
                  if (zVal) {
                    ...
                    wasm.pokePtr(
                      pArg,
                      wasm.allocCString("" + h.file.$szPage)
                    );
                    return 0;
                  }
                }
      ...
      try {
        ...
        for (const e of Object.entries(methodOverrides.recordHandler)) {
          ...
          recordHandler[k2] = f;
          if (0) {
            kvvfsMethods.installMethod(k2, f);
          } else {
        ...
        for (const e of Object.entries(methodOverrides.ioJrnl)) {
          ...
          if (true === f) {
            ...
            pIoJrnl[km] = wasm.installFunction(pIoJrnl.memberSignature(k2), f);
          }
        }
      } finally {
      ...
      const sqlite3_js_kvvfs_clear = function callee(which) {
        ...
        if (store.files.length) {
          if (globalThis.localStorage === store.storage || globalThis.sessionStorage === store.storage) {
          } else {
            toss3(
              capi.SQLITE_ACCESS,
      ...
      const sqlite3_js_kvvfs_export = function callee(...args) {
        ...
        if (1 === args.length && "object" === typeof args[0]) {
          ...
          opt = Object.assign(/* @__PURE__ */ Object.create(null), {
            name: args[0]
          });
        }
        ...
        Object.keys(pages).map((v2) => +v2).sort().forEach(
          (v2) => rc.pages.push(pages[v2])
        );
        return rc;
      };
      const sqlite3_js_kvvfs_import = function(exp, overwrite = false) {
        if (!exp?.timestamp || !exp.name || void 0 === exp.size || !Array.isArray(exp.pages)) {
          toss3(capi.SQLITE_MISUSE, "Malformed export object.");
        } else if (!exp.size || exp.size !== (exp.size | 0) || exp.size >= 2147483647) {
        ...
        try {
          ...
          if (exp.pages[0] instanceof Uint8Array) {
            ...
            exp.pages.forEach((v2, ndx) => s.setItem(keyPrefix + (ndx + 1), v2));
          }
      ...
      const sqlite3_js_kvvfs_listen = function(opt) {
        ...
        if (!store) {
          if (opt.storage && opt.reserve) {
            ...
            util.assert(
              store,
              "Unexpectedly cannot fetch reserved storage " + opt.storage
            );
          } else {
      ...
      const sqlite3_js_kvvfs_unlisten = function(opt) {
        ...
        if (store?.listeners && opt.events) {
          ...
          if (!store.listeners.length) {
            store.listeners = void 0;
          }
          return rc;
        }
        return false;
      };
      sqlite32.kvvfs.reserve = sqlite3_js_kvvfs_reserve;
      sqlite32.kvvfs.import = sqlite3_js_kvvfs_import;
      sqlite32.kvvfs.export = sqlite3_js_kvvfs_export;
      sqlite32.kvvfs.unlink = sqlite3_js_kvvfs_unlink;
      sqlite32.kvvfs.listen = sqlite3_js_kvvfs_listen;
      sqlite32.kvvfs.unlisten = sqlite3_js_kvvfs_unlisten;
      sqlite32.kvvfs.exists = (name) => !!storageForZClass(name);
      sqlite32.kvvfs.estimateSize = sqlite3_js_kvvfs_size;
      sqlite32.kvvfs.clear = sqlite3_js_kvvfs_clear;
      if (globalThis.Storage) {
      ...
      if (sqlite32.oo1?.DB) {
        ...
        sqlite32.oo1.JsStorageDb = function(storageName = sqlite32.oo1.JsStorageDb.defaultStorageName) {
        ...
        sqlite32.oo1.JsStorageDb.defaultStorageName = cache.storagePool.session ? "session" : nameOfThisThreadStorage;
      ...
      if (sqlite32.__isUnderTest && sqlite32.vtab) {
        ...
        const VT = sqlite32.vtab;
        const ProtoCursor = Object.assign(/* @__PURE__ */ Object.create(null), {
          row: function() {
        ...
        const dbg = 1 ? () => {
        } : (...args) => debug("vtab", ...args);
        const theModule = function f() {
          return f.mod ??= new sqlite32.capi.sqlite3_module().setupModule({
              ...
              xConnect: function(pDb2, pAux, argc, argv, ppVtab, pzErr) {
                ...
                try {
                  ...
                  const rc = capi.sqlite3_declare_vtab(
                    pDb2,
                    "CREATE TABLE ignored(" + xcol.join(",") + ")"
                  );
                  if (0 === rc) {
        ...
        sqlite32.kvvfs.create_module = function(pDb2, name = "sqlite_kvvfs") {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
      "use strict";
      if (sqlite32.config.disable?.vfs?.opfs && sqlite32.config.disable.vfs["opfs-vfs"]) {
        return;
      }
      const toss = sqlite32.util.toss, capi = sqlite32.capi, util = sqlite32.util, wasm = sqlite32.wasm;
      const opfsUtil = sqlite32.opfs = /* @__PURE__ */ Object.create(null);
      ...
      opfsUtil.vfsInstallationFeatureCheck = function(vfsName) {
        ...
        } else if (!globalThis.FileSystemHandle || !globalThis.FileSystemDirectoryHandle || !globalThis.FileSystemFileHandle?.prototype?.createSyncAccessHandle || !navigator?.storage?.getDirectory) {
      ...
      opfsUtil.initOptions = function callee(vfsName, options) {
        ...
        if (!opfsUtil.proxyUri) {
          ...
          if (sqlite32.scriptInfo?.sqlite3Dir) {
            opfsUtil.proxyUri = sqlite32.scriptInfo.sqlite3Dir + opfsUtil.proxyUri;
          }
        }
      ...
      opfsUtil.createVfsState = function() {
        ...
        const log = (...args) => logImpl(2, ...args), warn = (...args) => logImpl(1, ...args), error = (...args) => logImpl(0, ...args), capi2 = sqlite32.capi, wasm2 = sqlite32.wasm;
        const opfsVfs = state.vfs = new capi2.sqlite3_vfs();
        const opfsIoMethods = opfsVfs.ioMethods = new capi2.sqlite3_io_methods();
        opfsIoMethods.$iVersion = 1;
        opfsVfs.$iVersion = 2;
        opfsVfs.$szOsFile = capi2.sqlite3_file.structInfo.sizeof;
        ...
        opfsVfs.metrics = util.nu({
          ...
          dump: function() {
            ...
            sqlite32.config.log("Serialization metrics:", opfsVfs.metrics.counters.s11n);
          ...
          reset: function() {
            ...
            for (k2 in state.opIds) {
              r(m[k2] = /* @__PURE__ */ Object.create(null));
            }
        ...
        for (const k2 of [
          ...
          state.sq3Codes[k2] = capi2[k2] ?? toss("Maintenance required: not found:", k2);
        }
        ...
        const ioSyncWrappers = opfsVfs.ioSyncWrappers = util.nu({
          ...
          xDeviceCharacteristics: function(pFile) {
            return capi2.SQLITE_IOCAP_UNDELETABLE_WHEN_OPEN;
          },
          xFileControl: function(pFile, opId, pArg) {
            return capi2.SQLITE_NOTFOUND;
          },
          ...
          xRead: function(pFile, pDest, n, offset64) {
            ...
            try {
              ...
              if (0 === rc || capi2.SQLITE_IOERR_SHORT_READ === rc) {
                wasm2.heap8u().set(f.sabView.subarray(0, n), Number(pDest));
              }
            } catch (e) {
              error("xRead(", arguments, ") failed:", e, f);
              rc = capi2.SQLITE_IOERR_READ;
            }
            mTimeEnd();
            return rc;
          },
          ...
          xWrite: function(pFile, pSrc, n, offset64) {
            ...
            let rc;
            try {
              f.sabView.set(wasm2.heap8u().subarray(
                Number(pSrc),
                Number(pSrc) + n
              ));
        ...
        const vfsSyncWrappers = opfsVfs.vfsSyncWrappers = {
          ...
          xDelete: function(pVfs, zName, doSyncDir) {
            mTimeStart("xDelete");
            const rc = opRun("xDelete", wasm2.cstrToJs(zName), doSyncDir, false);
            mTimeEnd();
            return rc;
          },
          xFullPathname: function(pVfs, zName, nOut, pOut) {
            const i = wasm2.cstrncpy(pOut, zName, nOut);
            return i < nOut ? 0 : capi2.SQLITE_CANTOPEN;
          },
          xGetLastError: function(pVfs, nOut, pOut) {
            sqlite32.config.warn("OPFS xGetLastError() has nothing sensible to return.");
            return 0;
          },
          xOpen: function f(pVfs, zName, pFile, flags, pOutFlags) {
            ...
            if (!zName) {
              ...
              zName = zToFree = wasm2.allocCString(jzName);
            } else if (wasm2.isPtr(zName)) {
              if (capi2.sqlite3_uri_boolean(zName, "opfs-unlock-asap", 0)) {
                opfsFlags |= state.opfsFlags.OPFS_UNLOCK_ASAP;
              }
              if (capi2.sqlite3_uri_boolean(zName, "delete-before-open", 0)) {
                opfsFlags |= state.opfsFlags.OPFS_UNLINK_BEFORE_OPEN;
              }
              jzName = wasm2.cstrToJs(zName);
            } else {
              sqlite32.config.error("Impossible zName value in xOpen?", zName);
              return capi2.SQLITE_CANTOPEN;
            }
            const fh = util.nu({
              fid: pFile,
              filename: jzName,
              ...
              flags,
              readOnly: !(capi2.SQLITE_OPEN_CREATE & flags) && !!(flags & capi2.SQLITE_OPEN_READONLY)
            });
            const rc = opRun("xOpen", pFile, jzName, flags, opfsFlags);
            if (rc) {
              if (zToFree) wasm2.dealloc(zToFree);
            } else {
              if (fh.readOnly) {
                wasm2.poke(pOutFlags, capi2.SQLITE_OPEN_READONLY, "i32");
              }
              __openFiles[pFile] = fh;
              fh.sabView = state.sabFileBufView;
              fh.sq3File = new capi2.sqlite3_file(pFile);
              if (zToFree) fh.sq3File.addOnDispose(zToFree);
              fh.sq3File.$pMethods = opfsIoMethods.pointer;
              fh.lockType = capi2.SQLITE_LOCK_NONE;
            }
            mTimeEnd();
            return rc;
          }
        };
        const pDVfs = capi2.sqlite3_vfs_find(null);
        if (pDVfs) {
          const dVfs = new capi2.sqlite3_vfs(pDVfs);
        ...
        opfsVfs.bindVfs = function(ioMethods, callback) {
          ...
          const thePromise = new Promise(function(promiseResolve_, promiseReject_) {
            ...
            const proxyUri = options2.proxyUri + (options2.proxyUri.indexOf("?") < 0 ? "?" : "&") + "vfs=" + vfsName;
            const W = opfsVfs.worker = new Worker(new URL(proxyUri, import.meta.url));
            ...
            const opRun2 = opfsVfs.opRun;
            const sanityCheck = function() {
              const scope = wasm2.scopedAllocPush();
              const sq3File = new capi2.sqlite3_file();
              try {
                const fid = sq3File.pointer;
                const openFlags = capi2.SQLITE_OPEN_CREATE | capi2.SQLITE_OPEN_READWRITE | capi2.SQLITE_OPEN_MAIN_DB;
                ...
                rc = opfsVfs.vfsSyncWrappers.xOpen(
                  opfsVfs.pointer,
                  zDbFile,
                  fid,
                  openFlags,
                ...
                log("xFileSize says:", wasm2.peek(pOut, "i64"));
    ...
    "use strict";
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
      if (!sqlite32.opfs || sqlite32.config.disable?.vfs?.opfs) {
        return;
      }
      const util = sqlite32.util, opfsUtil = sqlite32.opfs || sqlite32.util.toss("Missing sqlite3.opfs");
      const installOpfsVfs = async function(options) {
        options = opfsUtil.initOptions("opfs", options);
        if (!options) return sqlite32;
        const capi = sqlite32.capi, state = opfsUtil.createVfsState(), opfsVfs = state.vfs, metrics = opfsVfs.metrics.counters, mTimeStart = opfsVfs.mTimeStart, mTimeEnd = opfsVfs.mTimeEnd, opRun = opfsVfs.opRun, debug = (...args) => sqlite32.config.debug("opfs:", ...args), warn = (...args) => sqlite32.config.warn("opfs:", ...args), __openFiles = opfsVfs.__openFiles;
        ...
        }), function(sqlite33, vfs) {
          if (sqlite33.oo1) {
            const OpfsDb = function(...args) {
              const opt = sqlite33.oo1.DB.dbCtorHelper.normalizeArgs(...args);
              opt.vfs = vfs.$zName;
              sqlite33.oo1.DB.dbCtorHelper.call(this, opt);
            };
            OpfsDb.prototype = Object.create(sqlite33.oo1.DB.prototype);
            sqlite33.oo1.OpfsDb = OpfsDb;
            OpfsDb.importDb = opfsUtil.importDb;
            if (true) {
              sqlite33.oo1.DB.dbCtorHelper.setVfsPostOpenCallback(
                opfsVfs.pointer,
                function(oo1Db, sqlite34) {
                  sqlite34.capi.sqlite3_busy_timeout(oo1Db, 1e4);
                }
              );
            }
          }
      ...
      globalThis.sqlite3ApiBootstrap.initializersAsync.push(async (sqlite33) => {
        return installOpfsVfs().catch((e) => {
          sqlite33.config.warn("Ignoring inability to install 'opfs' sqlite3_vfs:", e);
        });
      });
    });
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
      "use strict";
      if (sqlite32.config.disable?.vfs?.["opfs-sahpool"]) {
        return;
      }
      ...
      const setPoolForVfs = (pVfs, pool2) => {
        if (pool2) __mapVfsToPool.set(pVfs, pool2);
        else __mapVfsToPool.delete(pVfs);
      };
      const __mapSqlite3File = /* @__PURE__ */ new Map();
      const getPoolForPFile = (pFile) => __mapSqlite3File.get(pFile);
      const setPoolForPFile = (pFile, pool2) => {
        if (pool2) __mapSqlite3File.set(pFile, pool2);
        else __mapSqlite3File.delete(pFile);
      };
      const ioMethods = {
        xCheckReservedLock: function(pFile, pOut) {
          const pool2 = getPoolForPFile(pFile);
          pool2.log("xCheckReservedLock");
          pool2.storeErr();
          wasm.poke32(pOut, 1);
          return 0;
        },
        xClose: function(pFile) {
          const pool2 = getPoolForPFile(pFile);
          pool2.storeErr();
          const file = pool2.getOFileForS3File(pFile);
          if (file) {
            try {
              pool2.log(`xClose ${file.path}`);
              pool2.mapS3FileToOFile(pFile, false);
              file.sah.flush();
              if (file.flags & capi.SQLITE_OPEN_DELETEONCLOSE) {
                pool2.deletePath(file.path);
              }
            } catch (e) {
              return pool2.storeErr(e, capi.SQLITE_IOERR);
            }
          }
          return 0;
        },
        ...
        xRead: function(pFile, pDest, n, offset64) {
          ...
          pool2.storeErr();
          const file = pool2.getOFileForS3File(pFile);
          pool2.log(`xRead ${file.path} ${n} @ ${offset64}`);
          try {
        ...
        xWrite: function(pFile, pSrc, n, offset64) {
          ...
          pool2.storeErr();
          const file = pool2.getOFileForS3File(pFile);
          pool2.log(`xWrite ${file.path} ${n} ${offset64}`);
          try {
      ...
      const vfsMethods = {
        xAccess: function(pVfs, zName, flags, pOut) {
          const pool2 = getPoolForVfs(pVfs);
          pool2.storeErr();
          try {
            const name = pool2.getPath(zName);
            wasm.poke32(pOut, pool2.hasFilename(name) ? 1 : 0);
          } catch (e) {
            wasm.poke32(pOut, 0);
          }
          return 0;
        ...
        xDelete: function(pVfs, zName, doSyncDir) {
          const pool2 = getPoolForVfs(pVfs);
          pool2.log(`xDelete ${wasm.cstrToJs(zName)}`);
          pool2.storeErr();
          try {
            pool2.deletePath(pool2.getPath(zName));
            return 0;
          } catch (e) {
            pool2.storeErr(e);
        ...
        xGetLastError: function(pVfs, nOut, pOut) {
          const pool2 = getPoolForVfs(pVfs);
          const e = pool2.popErr();
          pool2.log(`xGetLastError ${nOut} e =`, e);
          if (e) {
            const scope = wasm.scopedAllocPush();
            try {
              const [cMsg, n] = wasm.scopedAllocCString(e.message, true);
        ...
        xOpen: function f(pVfs, zName, pFile, flags, pOutFlags) {
          ...
          try {
            ...
            pool2.log(`xOpen ${wasm.cstrToJs(zName)} ${flags}`);
            const path = zName && wasm.peek8(zName) ? pool2.getPath(zName) : getRandomName();
            let sah = pool2.getSAHForPath(path);
            if (!sah && flags & capi.SQLITE_OPEN_CREATE) {
              if (pool2.getFileCount() < pool2.getCapacity()) {
                sah = pool2.nextAvailableSAH();
                pool2.setAssociatedPath(sah, path, flags);
              } else {
            ...
            pool2.mapS3FileToOFile(pFile, file);
      ...
      class OpfsSAHPool {
        ...
        async removeVfs() {
          ...
          try {
            ...
            sqlite32.config.error(this.vfsName, "removeVfs() failed with no recovery strategy:", e);
          }
          return true;
        }
        pauseVfs() {
        ...
        async unpauseVfs() {
          if (0 === this.#mapSAHToName.size) {
            return this.acquireAccessHandles(false).then(() => capi.sqlite3_vfs_register(this.#cVfs, 0), this);
          }
          return this;
        }
        exportFile(name) {
    ...
    "use strict";
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite32) {
      if (!sqlite32.opfs || sqlite32.config.disable?.vfs?.["opfs-wl"]) {
        return;
      }
      const util = sqlite32.util, toss = sqlite32.util.toss;
      const opfsUtil = sqlite32.opfs;
      const vfsName = "opfs-wl";
      const installOpfsWlVfs = async function(options) {
        options = opfsUtil.initOptions(vfsName, options);
        if (!options) return sqlite32;
        const capi = sqlite32.capi, state = opfsUtil.createVfsState(), opfsVfs = state.vfs, metrics = opfsVfs.metrics.counters, mTimeStart = opfsVfs.mTimeStart, mTimeEnd = opfsVfs.mTimeEnd, opRun = opfsVfs.opRun, debug = (...args) => sqlite32.config.debug(vfsName + ":", ...args), warn = (...args) => sqlite32.config.warn(vfsName + ":", ...args), __openFiles = opfsVfs.__openFiles;
        return opfsVfs.bindVfs(util.nu({
          xLock: function(pFile, lockType) {
            mTimeStart("xLock");
            const f = __openFiles[pFile];
          ...
          if (sqlite33.oo1) {
            ...
            OpfsWlDb.prototype = Object.create(sqlite33.oo1.DB.prototype);
            sqlite33.oo1.OpfsWlDb = OpfsWlDb;
      ...
      globalThis.sqlite3ApiBootstrap.initializersAsync.push(async (sqlite33) => {
        return installOpfsWlVfs().catch((e) => {
          sqlite33.config.warn("Ignoring inability to install the", vfsName, "sqlite3_vfs:", e);
        });
      });
    });
    try {
...
var SqliteEncryptionError = class extends Error {
  ...
  constructor(code, message, opts) {
    super(message, opts?.cause !== void 0 ? {
      cause: opts.cause
    } : void 0);
...
var SQLITE3MC_DECRYPT_ERROR_PATTERNS = [
