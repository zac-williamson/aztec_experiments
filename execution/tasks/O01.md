...
1. Instrument liabilities/balance, sponsor balance, transaction failures, feed lag, signer health and moderation deadlines without secret/identity leakage.
2. Write executable operator runbooks for deploy, pause/exit, sponsor outage, RPC failover, policy/censor changes, credential rotation and recovery.
