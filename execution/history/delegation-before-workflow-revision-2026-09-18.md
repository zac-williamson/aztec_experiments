...
## T02 claim-boundary completion
Root owns wallet hook/profile/fingerprints and serialized actual run. deploy_fixture_integration owns isolated claim-input/membership-proxy helper; model_failure_review independently checks pinned constraints/oracle seam. Existing node/oracles are unchanged outside narrowly armed test probes; valid genuine claim remains positive control.
