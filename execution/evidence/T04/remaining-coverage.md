...
| Recovery | Chromium050 accepted post and096 accepted withdrawal response loss with full persistent browser restart; W03 receipt/persistence and chain tests | Map three interruption points per stage to existing tests; genuine distinct claim/screen browser recovery. Existing real-Anvil W03 deposit/refund and fee-funding tests already cover mined response loss with file-journal restart; browser integration is separate |
