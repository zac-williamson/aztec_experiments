...
| REQ04 | Posting and exit remain usable with concurrent authors, long histories and repeated deposits. | At least 10 concurrent authors and 1,000 lifetime posts per test account including multiple deposit cycles; no fixed history cutoff or starvation; measured workload budgets. |
...
| REQ10 | Deployment fails closed; operators can monitor, recover, rotate authority and manage sponsor outages. No exposed credential is treated as secret. | Rehearsal, runtime/address verification before linking/deposits, credential replacement/restriction, liability/fee/deadline alerts, drills and named owners. |
