...
export function runtimeConfiguration(config,additionalAssets=[]){return Buffer.from(JSON.stringify({schemaVersion:1,engine:'llama.cpp',engineVersion:config.image,contextSize:config.ctxSize,threads:config.threads,outputLimit:512,seedPolicy:'fixed0',inference:INFERENCE_OPTIONS,additionalAssets},null,2)+'\n');}
