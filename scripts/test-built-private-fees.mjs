...
for(const name of ['user','censor','deploy','fee-juice']) test(`${name} generated page binds the canonical privateFee and isolated RPC credential`,async()=>{
  ...
  const artifacts=scripts.filter(source=>source.includes('const BILLBOARD_PRIVATE_FEE_ARTIFACT ='));
