...
function walletFixture(engineSource=source){
 ...
 const node={getCurrentMinFees:async()=>new GasFees(3n,5n),getNodeInfo:async()=>({l1ChainId:31337,rollupVersion:5}),getContract:async()=>derivePrivateFeeInstance(artifact)};
