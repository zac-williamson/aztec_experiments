...
const required = [
  'plugins/client.mjs', 'plugins/protocol.mjs', 'plugins/ethereum.mjs',
...
function outputs(root) {
  ...
  visit('apps/dist');
  return hashes(root, [...names, 'apps/dist/plugins.js', 'apps/dist/public-feed.js', 'apps/dist/public-feed-metadata.json']);
}
